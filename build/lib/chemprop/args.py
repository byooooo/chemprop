...
class TrainArgs(CommonArgs):
    ...
    mpn_weight_embeddings: bool = False
    """Whether to use the weighted average message passing neural network for all input molecules
    Only relevant if :code:`number_of_molecules > 1 and mpn_shared is True`"""
    dropout: float = 0.0
    """Dropout probability."""
